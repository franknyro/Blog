...
プレイヤーは死んだ経験を通して自分のプレイを反省し、引くことを覚えていきます。上級者は数え切れないほど死んで経験を積んでいるので、より正確な判断が出来ます。

上級者のなかでも引くことの解釈は細かく違ってくるはずです。解釈は経験をもとに出来上がります。やがて独自の理論となり、個性としてあらわれます。

そういった、経験をもとにして自分の理論を構築することが、思考のはしごを登るということなのではないかと思います。

この本の中には何度も、思考のはしごを登ることができないと自分なりの考えを生み出せない、という警告が書かれています。「FPS 上達のコツは死んで覚えること」と言われたりしますが、なかなか正鵠を得ているのではないでしょうか。
