...
## どんな本？
思考のはしごを登る方法や心構えについてのエッセイ集

## 感想
FPS プレイヤーによく知られている名言に
...
プレイヤーは死んだ経験を通して自分のプレイを反省し、引くことを覚えていきます。上級者は数え切れないほど死んで経験を積んでいるので、より正確に引く判断が出来ます。初心者の考える引くことと、上級者の考える引くことは、同じ言葉ですが質が違います。

上級者のなかでも引くことの解釈は細かく違ってくるはずです。解釈は各々が積んできた経験を手がかりにするほかありません。そこにプレイの差が生まれます。

このように、経験をもとにして自分の理論を構築する、ということが思考のはしごを登るということなのではないかと思います。

また、この本では思考のはしごを登ることができないと、自分なりの考えを生み出せないと警告しています。「FPS 上達のコツは死んで覚えること」と言われたりしますが、なかなか正鵠を得ているのではないでしょうか。

そういえば格闘ゲームの世界に『思考の整理学』を実践しているプロゲーマーがいました。ウメハラこと梅原大悟さんです。格闘ゲームをやらない人でも名前を聞いたことがあるのではないでしょうか。
...
本をあまり読まないようなので、おそらく自分で試行錯誤するうちに考えついたのだと思いますが、この本で説明されていることと良く似た内容の発言をしています。
